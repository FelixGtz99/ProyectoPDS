...
import Principal.Validators.CompositeValidator;
import Principal.Validators.EmailRecordValidator;
import Principal.Validators.NameValidator;
import Principal.Validators.PasswordCareerValidator;
import Principal.Validators.TeacherValidator;
import Principal.Voto;
import Principal.todoDatos;

import Principal.Validators.Usuario;
import Principal.Validators.Validator;
...
public class Controller implements Initializable {
    ...
    @FXML
    private Button btnRegistrarAM;
    @FXML
    private Button btnIngresarAM;
    @FXML
    private Button btnCerrarAM;
    @FXML
    private Button btnSalirAM;
    //Elementos Evaluate
    @FXML
    private Button btnEnviarEV;
    @FXML
    private Button btnSalirEV;
    @FXML
    private ComboBox cbDocenteEV;
    @FXML
    private ComboBox cbMateriaEV;
    @FXML
    private Slider sliCalifEV;
    @FXML
    private TextArea txtComentarioEV;
    //Elementos Evaluation
    @FXML
    private Button btnSalirEN;
    @FXML
    private Button btnLikeEN;
    @FXML
    private Button btnDislikeEN;
    @FXML
    private ListView listEvaluation;
    //Elementos Login 
    @FXML
    ...
    //Elementos Menu
    @FXML
    private Button btnCuentaMenu;
    @FXML
    private Button btnRDMenu;
    @FXML
    private Button btnREMenu;
    @FXML
    private Button btnBuscarMenu;
    @FXML
    private Button btnARMenu;
    //Elementos Recent Activity
    @FXML
    private Button btnLikeRA;
    @FXML
    private Button btnDislikeRA;
    @FXML
    private Button btnSalirRA;
    @FXML
    private ListView listRA;
    //Elementos Searcher
    @FXML
    private Button btnSalirS;
    @FXML
    private Button btnBuscarS;
    @FXML
    private Button btnEvaluarS;
    @FXML
    private Button btnEvaluacionesS;
    @FXML
    private RadioButton rbDocenteS;
    @FXML
    private RadioButton rbMateriaS;
    @FXML
    ...
    @FXML
    private Button btnRegistrarTR;
    @FXML
    private Button btnSalirTR;
    @FXML
    private Button btnAddTR;
    @FXML
    private ListView listTR;
    @FXML
    private ComboBox cbMateriaTR;
    @FXML
    private TextField txtNombresTR;
    @FXML
    private TextField txtApellidosTR;
    @FXML
    private TextField txtAliasTR;
    //Elementos User Register
    @FXML
    private Button btnRegistrarUR;
    @FXML
    private Button btnSalirUR;
    @FXML
    private TextField txtNombresUR;
    @FXML
    private TextField txtApellidosUR;
    @FXML
    private TextField txtEmailUR;
    @FXML
    private TextField txtPasswordUR;
    @FXML
    private TextField txtExpedienteUR;
    @FXML
    private ComboBox cbCarreraUR;
    @FXML
...
//int id_usuario, int id_docentes, int id_materia, int id_evaluacion, double calificacion, String likes, String dislkes   
    ...
    public void RALikes() throws SQLException {
        ...
        for (int i = 0; i < EvaluacionesT.size(); i++) {
            System.out.println(EvaluacionesT.get(i).toString());
            if (e.equals(EvaluacionesT.get(i).toString())) {
                id = EvaluacionesT.get(i).getId_evaluacion();
                System.out.println(id);
            }
        }
        if (Votos.isEmpty()) {
 ...
 Alert Mensaje = new Alert(Alert.AlertType.INFORMATION, "La evaluacion fue eliminada por superar los 5 no me gusta", ButtonType.OK);
    ...
    public void UserRegister() {
        ...
        if (record.length() == 9) {
            int minnum = 200;
            int maxnum = 219;
            int r = Integer.parseInt(record.substring(0, 3));
            System.out.println(r);
            if (r > maxnum || r < minnum) {
                errores.add("Expediente no valido");
            }
        } else {
            errores.add("Debe ser de 9 digitos el expediente");
        }
        if (names.isEmpty() || surnames.isEmpty() || email.isEmpty() || password.isBlank()) {
            errores.add("Debes de llenar todos los campos");
        }
        if (!email.equals("a" + record + "@unison.mx") && !email.equals("a" + record + "@alumnos.unison.mx")) {
            errores.add("El formato de E-mail es incorrecto");
        }
        if (!Check.isSelected()) {
            errores.add("Debes de aceptar terminos y condiciones");
        }
        if (password.length() < 8) {
            errores.add("La contraseña debe ser mayor a 8 caracteres");
        } else if (password.length() > 16) {
            errores.add("La contraseña debe ser menor a 16 caracteres");
        } else if (!capsflag || !numflag || !specialflag) {
            errores.add("La contraseña debe contener al menos 1 mayúscula, 2 numeros y 2 caracteres especiales");
        }
        if (errores.isEmpty()) {
            ...
            try {
                ...
                Alert Mensaje = new Alert(Alert.AlertType.INFORMATION, "Contraseña no valida", ButtonType.OK);
                Mensaje.setTitle("");
